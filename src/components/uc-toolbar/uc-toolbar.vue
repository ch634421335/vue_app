...
<style scoped>
    ...
    .foot-btn ul .say{width:1.9rem;height:0.52rem; border-right:1px solid #e8eaec;}
    ...
    .fx i{width:0.33rem;height:0.08rem;display:block; margin:0 auto; padding-top:0.1rem;}
    .fx i img{width:100%;}
</style>