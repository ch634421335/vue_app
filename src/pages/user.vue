<template>
    <div class="content">
        <div class="header">
            ...
            <div class="user-box">
                <a href="login_m.html">{{user.nikename}}</a>
                <a href="reg_m.html" @click="logout">注销</a>
            </div>
            <ul class="clear">
                <li>
...
<style scoped>
    .content{max-width:6.4rem; margin:0.45rem auto 0.8rem;}
    ...
    .header h2 img{width:100%;height: 90%}
